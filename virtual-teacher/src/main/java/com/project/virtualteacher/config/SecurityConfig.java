    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers(HttpMethod.GET,"/api/v1/user/register","/api/v1/course/{id}/public/basic","/api/v1/role/{id}","/api/v1/course/title/basic","/api/v1/course/all-public/basic","/api/v1/lecture/{id}/public/basic").permitAll()
                        .requestMatchers(HttpMethod.GET,"/api/v1/user/{id}", "/api/v1/user/{id}/basic", "/api/v1/course/title","/api/v1/course/{courseId}/full","/api/v1/course/all/full","/api/v1/lecture/{lectureId}").authenticated()
                        .requestMatchers("/api/v1/user/{id}/block", "/api/v1/user/{id}/unblock", "/api/v1/user/{id}/role/{id}","/api/v1/role").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/v1/course/{courseId}","/api/v1/lecture/{lectureId}").hasRole("TEACHER")
